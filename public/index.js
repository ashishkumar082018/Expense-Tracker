        ...
        .then(result => {
            ...
            result.data.expenses.forEach(expense => {
                ...
                editBtn.addEventListener("click", () => {
                    axios.delete(`http://localhost:3000/expense/delete-expense/${editBtn.parentElement.id}`, { headers: { "Authorization": token } })
                        .then(res => {
                ...
                deleteBtn.addEventListener("click", () => {
                    axios.delete(`http://localhost:3000/expense/delete-expense/${deleteBtn.parentElement.id}`, { headers: { "Authorization": token } })
                        .then(res => {
